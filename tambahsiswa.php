...
// cek apakah tombol simpan sudah ditekan/belum
if(isset($_POST["simpan"])) {

  // tangkap / ambil nilai yang dimasukkan pengguna di input
...
$simpan = mysqli_query($koneksi, "INSERT INTO siswa VALUES(
'', '$nis', '$nama', '$tanggal_lahir', '$jurusan', '$alamat', '$status', '$gambar')");
